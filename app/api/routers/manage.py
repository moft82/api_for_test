...
def main(request:Request):
    ...
    return templates.TemplateResponse("manage.html", {"request" : request, "available_status":available_status, "selectable_status":selectable_status})
...
# def read_item(id: int, db: Session = Depends(db.get_db)):
